...
See [docs/api-reference.md](docs/api-reference.md) for the full reference, and [docs/compatibility.md](docs/compatibility.md) for the SDK-server compatibility matrix.
