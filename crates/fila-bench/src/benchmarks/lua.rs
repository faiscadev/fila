...
/// Measure Lua on_enqueue execution latency at p99 (NFR4: <50us).
///
/// Approach: measure enqueue throughput with and without Lua. The difference
/// in per-message latency is the Lua execution overhead.
